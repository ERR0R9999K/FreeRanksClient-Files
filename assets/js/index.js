...
const REG_DATABASE_URL = 'https://script.google.com/macros/s/AKfycbxBbj28o3llFuUN0HCdirAd6dEBO326qusx_7E5mxA9LQnNGokB_G2ZAQGUzza41Lyq/exec';
...
function generateAndDownloadClient() {
    ...
    cape: "${cape}"
            ...
            console.log('✅ Client generated successfully for:', nick);
        })
        .catch(error => {
